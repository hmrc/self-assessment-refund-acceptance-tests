...
##Safari iOS iPhone
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${HISTORY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="iphone" -Dbrowserstack.browser_version=${SAFARI_iOS_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeHistoryRunner'
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${JOURNEY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="iphone" -Dbrowserstack.browser_version=${SAFARI_iOS_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeJourneyRunner'
###Safari iOS iPad
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${HISTORY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="ipad" -Dbrowserstack.browser_version=${SAFARI_iOS_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeHistoryRunner'
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${JOURNEY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="ipad" -Dbrowserstack.browser_version=${SAFARI_iOS_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeJourneyRunner'
###Chrome iPhone
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${HISTORY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="Chrome" -Dbrowserstack.browser_version=${CHROME_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeHistoryRunner'
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${JOURNEY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="Chrome" -Dbrowserstack.browser_version=${CHROME_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeJourneyRunner'
###Chrome iPad
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${HISTORY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="Chrome" -Dbrowserstack.browser_version=${CHROME_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeHistoryRunner'
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${browserStackUsername} -Dbrowserstack.key=${browserStackAutomateKey} -Dbrowserstack.project=${PROJECT_NAME} -Dbrowserstack.build=${PROJECT_NAME}" "${DATE} -Dbrowserstack.name=${JOURNEY} -Dbrowserstack.os="ios" -Dbrowserstack.os_version=${iOS} -Dbrowserstack.browser="Chrome" -Dbrowserstack.browser_version=${CHROME_VERSION} 'testOnly uk.gov.hmrc.test.ui.runner.SmokeJourneyRunner'
